<%-- 
    Document   : report
    Created on : Mar 6, 2015, 2:42:47 AM
    Author     : SULAIMAN
--%>
...
<html>
    ...
    <body>
        <%
            String value=request.getParameter("taxpayerType");
            String type="";
            ...
            try {
              //  String itnm = request.getParameter("username");
                ...
                for(Individual in: Individual.listIndividual()) {
                    for(TaxPayerType t: TaxPayerType.listTaxPayerType()){
                        if(t.getId()==Integer.parseInt(in.getTaxpayerType())){
                           if(t.getTaxpayerType().equalsIgnoreCase(type)){
                    ...
                    table5.addCell(new Phrase(new Chunk(in.getTaxpayerRepresentativeName(), font5)));
